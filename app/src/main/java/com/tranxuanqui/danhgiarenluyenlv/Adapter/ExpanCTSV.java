...
import com.tranxuanqui.danhgiarenluyenlv.Activity.CanBoPhongCTHSSV.ChamDiemCTSVActivity;
...
public class ExpanCTSV extends BaseExpandableListAdapter {
    private int value;
    ...
    public ExpanCTSV(Context context) {
        mContext = context;
    }
        ...
        chkdiem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(chkdiem.isChecked()){
                    k.setCheck(true);
                    ChamDiemCTSVActivity.updateDiem();
                }else {
                    k.setCheck(false);
                    ChamDiemCTSVActivity.updateDiem();
                }
